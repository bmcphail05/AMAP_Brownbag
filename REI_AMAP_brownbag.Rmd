...
- Intraclass Correlation Coeficient (ICC) = .05   
  ...
  - Individuals' self-rated health within prefectures are not much more similar to each other than observations across prefectures
...
.footer[.left[Note: Predicted probabilities calculated from Model 6 which includes all five religions]]
---
class:center
**Predicted Probabilities of Self-Rated Heath - Daoist sites**  
*Mixed Effects Ordered Logit Model*
<img src= "https://github.com/bmcphail05/AMAP_Brownbag/blob/main/images/dao_marginsplot.jpg?raw=true" width = "70%" />
