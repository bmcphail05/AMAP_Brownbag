...
- Random intercept models with 4-levels of data
- Likelihood-ratio tests suggest four-level models are preferred over the three-level and two-level models. 

- Variance Components Model indicates that only ...
- icc = .05
- Correlation of self-rated health among respondents in the same prefecture is only .05.

---
**Predicted Probability of Self-Rated Heath**
...
dao10k       |                                            
     ...
     p-value |     0.008      0.038      0.009      0.012 
