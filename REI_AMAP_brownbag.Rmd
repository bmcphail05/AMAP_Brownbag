...
<br>
.footer[.center[.tiny[Note: <sup>+</sup> *p* < .10, <sup>\*</sup> *p* < .05; AMEs calculated from Model 6 using observed values]]]
...
Increased concentration of Muslim sites in Chinese prefectures is associated with lower levels of self-rated health among older Chinese adults. For each SD increase in Muslims sites per 10k, there is a .015 increase in probability of having **poor** health. 

Increased concentration of Daoist sites in Chinese prefectures is associated with higher levels of self-rated health among older Chinese adults. For each SD increase in Daoist sites per 10k, there is a .019 increase in probability of having **very good** health. 
